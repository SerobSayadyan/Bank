...
public class IndividualRegistration {
     ...
     * Frame dimensions
     */
    private static final int frameWidth = 1100;
    //Frame width
    private static int frameHeight = 420;
     ...
     */
    private final String[] labelNameSurname = {"Անուն*","Ազգանուն*"};

    private final String[] labelPassportAndDate = {"Անձնագիր*","Սկիզբ*","Վերջ*"};

    private final String[] labelSocialCard = {"Սոցքարտ*"};
    ...
    public IndividualRegistration() {
        ...
        addLabelAndField(labelNameSurname);
        addGenderComboBox();
        addLabelAndField(labelPassportAndDate);
        addLabelAndField(labelSocialCard);
