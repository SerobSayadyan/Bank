...
public class PrivateEntrepreneurLogin {
     ...
     */
    private static final String[] labelNames = {"Անուն","Անձնագիր","ՀՎՀՀ","Հաճախորդի կոդ"};
    ...
    public PrivateEntrepreneurLogin() {
        //Creating frame
        createFrame();
